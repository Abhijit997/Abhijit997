...
🚀 Technical Expertise
* Data Engineering & Real-time ETL
  * Real-time Streaming: Spring Boot microservices, AWS Lambda, Kinesis Streams, Kafka.
  * Batch & Orchestration: Airflow, Azure Databricks, AWS Glue, DBT, Apache Iceberg.
  * Storage & DBs: Snowflake, Redshift, Oracle RMS, MongoDB, Neo4j (Graph/Vector).
* Generative AI & Agentic Systems
  * Frameworks: LangChain, LangGraph (Multi-agent systems), HuggingFace.
  * Architecture: RAG (Retrieval-Augmented Generation), LLM Finetuning, Prompt Engineering.
  * Platforms: AWS Sagemaker, IBM WatsonX, Microsoft Foundry.
* DevSecOps & Cloud
  * Platforms: Azure Kubernetes Service (AKS), Docker, AWS, Azure.
  * CI/CD: GitLab CI, Azure DevOps, Terraform.

💼 Professional Impact at Infosys
* ETL Lead: Managing cross-functional development and support teams for global enterprise data repositories.
* Multi-Cloud Migration: Architecting complex ETL/ELT migrations from on-prem to AWS/Azure using a modern data stack (DBT + Dremio).
